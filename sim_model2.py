...
Original file is located at
    https://colab.research.google.com/drive/1yJ29_ayvj5SEaLcfJtSpF0cvZhqqlhzN
"""
...
hidden_layer1 = tf.layers.dense(inputs=x,units = 50, activation= tf.nn.tanh)
hidden_layer2 = tf.layers.dense(inputs=hidden_layer1,units = 10, activation= tf.nn.tanh)
hidden_layer3 = tf.layers.dense(inputs=hidden_layer2,units = 4, activation= tf.nn.tanh)
