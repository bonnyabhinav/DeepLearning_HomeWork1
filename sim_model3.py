...
Original file is located at
    https://colab.research.google.com/drive/115cDLDVOL0k3XuvsA43J0XfRs0S4s_mP
"""
...
hidden_layer1 = tf.layers.dense(inputs=x,units = 50, activation= tf.nn.sigmoid)
hidden_layer2 = tf.layers.dense(inputs=hidden_layer1,units = 10, activation= tf.nn.sigmoid)
hidden_layer3 = tf.layers.dense(inputs=hidden_layer2,units = 4, activation= tf.nn.sigmoid)
output_layer = tf.layers.dense(hidden_layer3,units=1)
